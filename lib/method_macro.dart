...
macro class ClientMacro implements ClassDeclarationsMacro {
  ...
  FutureOr<void> buildDeclarationsForClass(ClassDeclaration clazz, MemberDeclarationBuilder builder) {
    ...
    builder.declareInLibrary(DeclarationCode.fromString("import 'package:dio/src/options.dart';"));
  }
}
...
FutureOr<void> _buildMethod(String methodType, String path, MethodDeclaration method, FunctionDefinitionBuilder builder,
...
Future<List<Object>> _buildBody(List<FormalParameterDeclaration> fields, List<Object> stringDynamicMapType,
  ...
  if (bodyParams.isNotEmpty && partParams.isEmpty) {
    ...
    final multipartFileType =
        await builder.resolveIdentifier(Uri.parse('package:dio/src/multipart_file.dart'), 'MultipartFile');
    ...
    bodyCreationCode.addAll([
      ...
      ...partParams.map((part) {
        ...
        final partParamType = type is NamedTypeAnnotation
  ...
  if (headerParams.isNotEmpty) {
    ...
    headerParamsCreationCode.addAll([
      ...
      ...headerParams.map((e) {
        ...
        final meta =
            e.metadata.firstWhereOrNull((e) => e.hasAnnotationOf(headerSignature)) as ConstructorMetadataAnnotation;
